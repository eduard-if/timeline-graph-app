...
const TimelineDeleteModal = ({ showDelete, handleCloseDelete, itemId, setShowDeleteToast }) => {
    ...
    return (
        <Modal show={showDelete} onHide={handleCloseDelete} scrollable='true' centered>
            ...
            <Modal.Footer className='justify-content-center border-0' >
                {timelineDelete.loading ? <PuffLoader color='#17141f' role='status' className='mx-auto my-3' speedMultiplier={2} />
                    : (
                        <>
